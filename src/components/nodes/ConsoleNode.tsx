...
export const ConsoleNode = ({ data }: any) => {
  ...
  return (
    <div className="bg-slate-800 border-2 border-emerald-600 rounded-md p-2 min-w-[200px] shadow-lg flex flex-col">
      ...
      <div className="flex justify-between">
        {/* Left side: D0-D7, WR, MODE, CLR */}
        <div className="flex flex-col gap-1">
          <div className="text-[8px] text-blue-400 font-bold">DATA</div>
